...
:root{
  ...
  --glow:0 0 60px rgba(196,106,43,0.18);
...
/* ANNOUNCEMENT */
.announce{background:var(--dark);color:#E8DDD2;padding:10px 24px;text-align:center;font-size:13px;font-weight:500;display:flex;align-items:center;justify-content:center;gap:8px}
.announce a{color:var(--accent);font-weight:600;border-bottom:1px solid rgba(196,106,43,.3);padding-bottom:1px}
...
.nav-logo{display:flex;align-items:center;gap:10px;font-weight:700;font-size:18px;letter-spacing:-0.3px;color:var(--text)}
.nav-logo-mark{width:32px;height:32px;background:var(--dark);border-radius:9px;display:flex;align-items:center;justify-content:center;position:relative}
...
.hero-badge-pill{background:var(--accent-bg);color:var(--accent);font-size:11px;font-weight:700;padding:3px 10px;border-radius:100px;text-transform:uppercase;letter-spacing:.04em}
...
.hero-sub{font-size:clamp(16px,2vw,20px);color:var(--text2);max-width:620px;margin:0 auto 40px;line-height:1.6;font-weight:400}
...
/* DASHBOARD PREVIEW */
.preview-wrap{max-width:1100px;margin:60px auto 0;padding:0 24px;position:relative}
.preview-wrap::before{content:"";position:absolute;top:30%;left:50%;transform:translateX(-50%);width:80%;height:60%;background:rgba(196,106,43,.15);filter:blur(80px);z-index:0;pointer-events:none}
.preview{background:var(--card);border:1px solid var(--border);border-radius:20px;box-shadow:0 30px 80px rgba(24,17,10,0.12);overflow:hidden;position:relative;z-index:1}
.preview-bar{background:#FAF6F0;border-bottom:1px solid var(--border);padding:12px 18px;display:flex;align-items:center;gap:8px}
.preview-dot{width:11px;height:11px;border-radius:50%}
.preview-dot.r{background:#F56565}
.preview-dot.y{background:#ECC94B}
.preview-dot.g{background:#48BB78}
.preview-url{margin-left:auto;font-size:12px;color:var(--text3);background:white;padding:4px 14px;border-radius:6px;border:1px solid var(--border)}
.preview-body{display:grid;grid-template-columns:220px 1fr;min-height:480px}
.preview-side{background:#FBF8F2;border-right:1px solid var(--border);padding:20px 14px}
.preview-side-logo{display:flex;align-items:center;gap:8px;margin-bottom:24px;padding:0 6px}
.preview-side-logo-mark{width:24px;height:24px;background:var(--dark);border-radius:6px}
.preview-side-logo-text{font-size:13px;font-weight:700}
.preview-side-item{display:flex;align-items:center;gap:10px;padding:8px 10px;border-radius:8px;font-size:13px;color:var(--text2);margin-bottom:2px;cursor:pointer}
.preview-side-item.active{background:white;color:var(--text);font-weight:600;box-shadow:var(--shadow)}
.preview-side-item i{font-size:15px}
.preview-main{padding:24px 28px}
.preview-h{display:flex;align-items:center;justify-content:space-between;margin-bottom:24px}
.preview-h h3{font-size:18px;font-weight:700;color:var(--text)}
.preview-h-meta{font-size:12px;color:var(--text3)}
.preview-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:24px}
.preview-stat{background:#FAF6F0;border:1px solid var(--border);border-radius:12px;padding:14px}
.preview-stat-l{font-size:11px;color:var(--text3);text-transform:uppercase;font-weight:600;letter-spacing:.05em}
.preview-stat-v{font-size:22px;font-weight:800;color:var(--text);margin-top:4px;font-family:'Plus Jakarta Sans',sans-serif}
.preview-stat-c{font-size:11px;color:var(--success);margin-top:2px;font-weight:600}
.preview-stat-c.down{color:var(--danger)}
.preview-row{display:flex;align-items:center;justify-content:space-between;padding:12px 0;border-bottom:1px solid var(--border2)}
.preview-row:last-child{border-bottom:none}
.preview-row-l{display:flex;align-items:center;gap:12px}
.preview-row-icon{width:36px;height:36px;border-radius:8px;background:var(--accent-bg);display:flex;align-items:center;justify-content:center;color:var(--accent);font-weight:700;font-size:13px}
.preview-row-text{font-size:13px;font-weight:600;color:var(--text)}
.preview-row-sub{font-size:11px;color:var(--text3);margin-top:2px}
.preview-tag{font-size:11px;padding:4px 10px;border-radius:6px;font-weight:600}
.preview-tag.ok{background:#E5F0E9;color:var(--success)}
.preview-tag.warn{background:#FBF1DA;color:#856216}
.preview-tag.err{background:#FAE5E0;color:var(--danger)}
...
.trusted-logo{font-family:'Plus Jakarta Sans',sans-serif;font-size:18px;font-weight:700;color:var(--text2);letter-spacing:-0.3px}
...
.feat-card{background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:32px;transition:all .3s ease;position:relative;overflow:hidden}
.feat-card:hover{transform:translateY(-4px);box-shadow:var(--shadow-lg);border-color:var(--accent-bg)}
.feat-card::before{content:"";position:absolute;top:0;right:0;width:100px;height:100px;background:radial-gradient(circle at top right,var(--accent-bg),transparent);opacity:0;transition:opacity .3s}
.feat-card:hover::before{opacity:1}
.feat-icon{width:48px;height:48px;border-radius:12px;background:var(--accent-bg);display:flex;align-items:center;justify-content:center;margin-bottom:20px;position:relative;z-index:1}
.feat-icon i{font-size:22px;color:var(--accent)}
.feat-title{font-family:'Plus Jakarta Sans',sans-serif;font-size:18px;font-weight:700;margin-bottom:10px;color:var(--text);position:relative;z-index:1}
.feat-desc{font-size:14px;color:var(--text2);line-height:1.7;position:relative;z-index:1}

/* STEPS */
.steps-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:24px}
.step-card{background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:36px 28px;position:relative;transition:all .3s}
...
.test-avatar{width:40px;height:40px;border-radius:50%;background:var(--accent-bg);color:var(--accent);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:13px;font-family:'Plus Jakarta Sans',sans-serif}
.test-name{font-size:14px;font-weight:700;color:var(--text)}
.test-role{font-size:12px;color:var(--text3);margin-top:1px}

/* PRICING */
.section-pricing{background:var(--bg2)}
.price-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:20px;max-width:1080px;margin:0 auto}
.price-card{background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:36px 30px;position:relative;transition:all .3s}
.price-card:hover{transform:translateY(-4px);box-shadow:var(--shadow-lg)}
.price-card.featured{background:var(--dark);color:#F7F4EE;border:none}
.price-card.featured .price-name{color:#F7F4EE}
.price-card.featured .price-desc{color:#B8AC9F}
.price-card.featured .price-amount{color:white}
.price-card.featured .price-amount-sub{color:#B8AC9F}
.price-card.featured .price-feature{color:#D4C6B6}
.price-badge{position:absolute;top:-12px;left:50%;transform:translateX(-50%);background:var(--accent);color:white;font-size:11px;font-weight:700;padding:5px 14px;border-radius:100px;text-transform:uppercase;letter-spacing:.05em}
.price-name{font-family:'Plus Jakarta Sans',sans-serif;font-size:16px;font-weight:700;color:var(--text);margin-bottom:6px}
.price-desc{font-size:13px;color:var(--text2);margin-bottom:24px}
.price-amount{font-family:'Plus Jakarta Sans',sans-serif;font-size:48px;font-weight:800;letter-spacing:-2px;color:var(--text)}
.price-amount-sub{font-size:14px;font-weight:500;color:var(--text2)}
...
.price-btn{display:block;text-align:center;padding:13px;border-radius:var(--radius-btn);font-size:14px;font-weight:600;transition:all .2s;width:100%;cursor:pointer;border:1px solid var(--border);background:white;color:var(--text)}
.price-btn:hover{background:var(--bg)}
.price-card.featured .price-btn{background:var(--accent);color:white;border-color:var(--accent)}
.price-card.featured .price-btn:hover{background:var(--accent-hover)}

/* FAQ */
.faq-list{max-width:780px;margin:0 auto}
.faq-item{background:var(--card);border:1px solid var(--border);border-radius:16px;margin-bottom:12px;overflow:hidden;transition:all .2s}
.faq-item:hover{border-color:var(--text3)}
.faq-q{padding:22px 24px;font-size:16px;font-weight:600;color:var(--text);cursor:pointer;display:flex;align-items:center;justify-content:space-between;user-select:none}
...
.faq-a{padding:0 24px;max-height:0;overflow:hidden;transition:all .3s ease;font-size:14px;color:var(--text2);line-height:1.7}
...
.cta-inner::after{content:"";position:absolute;bottom:-150px;left:-50px;width:300px;height:300px;background:radial-gradient(circle,rgba(196,106,43,.2),transparent 70%);pointer-events:none}
...
.footer-bottom-links a{font-size:13px;color:#7A6E5F}
...
<div class="announce">
  ...
  New: WhatsApp screenshot QC is now live
...
<section class="hero">
  <div class="hero-inner">
    ...
    <p class="hero-sub">SurveyQC reads your screener doc, crawls your live survey, and flags 15+ types of issues automatically — in any language, on any platform.</p>
    <div class="hero-cta">
...
<div class="preview-wrap">
  <div class="preview">
    <div class="preview-bar">
      ...
      <div class="preview-url">app.surveyqc.online/dashboard</div>
    </div>
    <div class="preview-body">
      <div class="preview-side">
        <div class="preview-side-logo">
          <div class="preview-side-logo-mark"></div>
          <span class="preview-side-logo-text">SurveyQC</span>
        </div>
        <div class="preview-side-item active"><i class="ti ti-home"></i>Dashboard</div>
        <div class="preview-side-item"><i class="ti ti-plus"></i>New QC</div>
        <div class="preview-side-item"><i class="ti ti-file-report"></i>Reports</div>
        <div class="preview-side-item"><i class="ti ti-copy"></i>Templates</div>
        <div class="preview-side-item"><i class="ti ti-settings"></i>Settings</div>
      </div>
      <div class="preview-main">
        <div class="preview-h">
          <div>
            <h3>Welcome back, Sarah</h3>
            <div class="preview-h-meta">Tuesday, 19 May 2026</div>
          </div>
          <span style="background:var(--accent-bg);color:var(--accent);font-size:11px;font-weight:700;padding:5px 12px;border-radius:100px">PRO PLAN</span>
        </div>
        <div class="preview-stats">
          <div class="preview-stat">
            <div class="preview-stat-l">Reports this month</div>
            <div class="preview-stat-v">47</div>
            <div class="preview-stat-c">+12%</div>
          </div>
          <div class="preview-stat">
            <div class="preview-stat-l">Issues caught</div>
            <div class="preview-stat-v">312</div>
            <div class="preview-stat-c">+8%</div>
          </div>
          <div class="preview-stat">
            <div class="preview-stat-l">Time saved</div>
            <div class="preview-stat-v">47h</div>
            <div class="preview-stat-c">+24%</div>
          </div>
          <div class="preview-stat">
            <div class="preview-stat-l">Pass rate</div>
            <div class="preview-stat-v">94%</div>
            <div class="preview-stat-c">+3%</div>
          </div>
        </div>
        <div style="font-size:13px;font-weight:700;color:var(--text2);text-transform:uppercase;letter-spacing:.05em;margin-bottom:14px">Recent reports</div>
        <div class="preview-row">
          <div class="preview-row-l">
            <div class="preview-row-icon">CF</div>
            <div>
              <div class="preview-row-text">Q3_2026_TrackerStudy.docx</div>
              <div class="preview-row-sub">Confirmit · 47 questions · 3 issues</div>
            </div>
          </div>
          <span class="preview-tag warn">3 issues</span>
        </div>
        <div class="preview-row">
          <div class="preview-row-l">
            <div class="preview-row-icon" style="background:#E5F0E9;color:var(--success)">QT</div>
            <div>
              <div class="preview-row-text">FR_BeautyAdHoc_v2.docx</div>
              <div class="preview-row-sub">Qualtrics · 32 questions · All clear</div>
            </div>
          </div>
          <span class="preview-tag ok">Passed</span>
        </div>
        <div class="preview-row">
          <div class="preview-row-l">
            <div class="preview-row-icon" style="background:#FAE5E0;color:var(--danger)">DE</div>
            <div>
              <div class="preview-row-text">US_FoodBev_Q2.docx</div>
              <div class="preview-row-sub">Decipher · 58 questions · 12 issues</div>
            </div>
          </div>
          <span class="preview-tag err">12 issues</span>
        </div>
      </div>
    </div>
  </div>
...
<section class="section" id="features">
  <div class="container">
    <div class="sec-head">
      ...
      <p class="sec-sub">15+ specialized checks run in parallel. From termination logic to missing words, nothing slips through.</p>
    </div>
    <div class="feat-grid">
      <div class="feat-card">
        <div class="feat-icon"><i class="ti ti-x-octagon"></i></div>
        <div class="feat-title">Termination Testing</div>
        <div class="feat-desc">Every terminate/close rule actually clicked and verified. PASS/FAIL per rule with screenshot proof attached.</div>
      </div>
      <div class="feat-card">
        <div class="feat-icon"><i class="ti ti-text-recognition"></i></div>
        <div class="feat-title">Missing Words Detection</div>
        <div class="feat-desc">Word-by-word comparison between your spec doc and live survey. Catches every typo and missing phrase instantly.</div>
      </div>
      <div class="feat-card">
        <div class="feat-icon"><i class="ti ti-camera"></i></div>
        <div class="feat-title">Auto Screenshots</div>
        <div class="feat-desc">Every question captured automatically. Bug found? Screenshot attached as visual proof in your final report.</div>
      </div>
      <div class="feat-card">
        <div class="feat-icon"><i class="ti ti-world"></i></div>
        <div class="feat-title">Any Language</div>
        <div class="feat-desc">French, Italian, Arabic, Urdu, Japanese — 80+ languages with full encoding and accent character support.</div>
      </div>
      <div class="feat-card">
        <div class="feat-icon"><i class="ti ti-shield-check"></i></div>
        <div class="feat-title">15+ QC Checks</div>
        <div class="feat-desc">Termination, text match, missing words, piping, codes, mandatory, options, order — all parallel verified.</div>
      </div>
      <div class="feat-card">
        <div class="feat-icon"><i class="ti ti-refresh"></i></div>
        <div class="feat-title">One-click Retest</div>
        <div class="feat-desc">Fix the bugs, retest only the failed paths in seconds. No need to run full QC again from scratch.</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="steps-grid">
      <div class="step-card">
        ...
        <div class="step-desc">Upload your screener .docx and paste the live survey URL. Add screenshots optionally for targeted checks. Takes 30 seconds.</div>
      </div>
      <div class="step-card">
        <div class="step-num">02</div>
        <div class="step-title">AI tests everything</div>
        <div class="step-desc">AI crawls every path, runs all 15+ checks in parallel, captures screenshots. Termination rules actually clicked and verified.</div>
      </div>
      <div class="step-card">
        <div class="step-num">03</div>
        <div class="step-title">Download Word report</div>
        <div class="step-desc">Professional report with all issues, severity levels, screenshot proof, fix suggestions, and a QC certificate for clients.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="section" id="testimonials">
  <div class="container">
    <div class="sec-head">
      ...
      <p class="sec-sub">From market research agencies to in-house teams — hear what professionals say.</p>
    </div>
    <div class="test-grid">
      <div class="test-card">
        ...
        <div class="test-quote">"8 hours of manual QC now takes 10 minutes. Caught a termination bug that would have killed our entire dataset — saved us a $40K project."</div>
        <div class="test-author">
          <div class="test-avatar">ST</div>
          <div>
            <div class="test-name">Sarah Thompson</div>
            <div class="test-role">QC Manager, London</div>
          </div>
        </div>
      </div>
      <div class="test-card">
        <div class="test-stars"><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i></div>
        <div class="test-quote">"French, Italian, Spanish — SurveyQC handles all perfectly. Screenshot evidence is a total game changer for client reports. Industry-leading."</div>
        <div class="test-author">
          <div class="test-avatar">ML</div>
          <div>
            <div class="test-name">Marie Laurent</div>
            <div class="test-role">Research Director, Paris</div>
          </div>
        </div>
      </div>
      <div class="test-card">
        <div class="test-stars"><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i></div>
        <div class="test-quote">"Saved our team 47 hours this month. ROI is insane. Nothing else even comes close to this level of automation for survey professionals."</div>
        <div class="test-author">
          <div class="test-avatar">JM</div>
          <div>
            <div class="test-name">James Mitchell</div>
            <div class="test-role">Ops Lead, New York</div>
          </div>
        </div>
      </div>
    </div>
...
<section class="section section-pricing" id="pricing">
  <div class="container">
    <div class="sec-head">
      ...
      <h2 class="sec-title">Simple, transparent<br>pricing.</h2>
      <p class="sec-sub">Start free. Upgrade when you need more. No contracts, cancel anytime.</p>
    </div>
    <div class="price-grid">
      <div class="price-card">
        <div class="price-name">Free</div>
        <div class="price-desc">For solo testers</div>
        <div><span class="price-amount">$0</span><span class="price-amount-sub">/month</span></div>
        <div class="price-features">
          <div class="price-feature"><i class="ti ti-check"></i>5 reports per month</div>
          <div class="price-feature"><i class="ti ti-check"></i>All 15+ QC checks</div>
          <div class="price-feature"><i class="ti ti-check"></i>Word report download</div>
          <div class="price-feature"><i class="ti ti-check"></i>20K tokens per report</div>
          <div class="price-feature"><i class="ti ti-check"></i>Any language</div>
        </div>
        <a href="/signup" class="price-btn">Get started</a>
      </div>
      <div class="price-card featured">
        <span class="price-badge">Most Popular</span>
        <div class="price-name">Pro</div>
        <div class="price-desc">For QC professionals</div>
        <div><span class="price-amount">$29</span><span class="price-amount-sub">/month</span></div>
        <div class="price-features">
          <div class="price-feature"><i class="ti ti-check"></i>50 reports per month</div>
          <div class="price-feature"><i class="ti ti-check"></i>Everything in Free</div>
          <div class="price-feature"><i class="ti ti-check"></i>Screenshot QC (WhatsApp)</div>
          <div class="price-feature"><i class="ti ti-check"></i>Share reports with clients</div>
          <div class="price-feature"><i class="ti ti-check"></i>100K tokens per report</div>
          <div class="price-feature"><i class="ti ti-check"></i>Priority support</div>
        </div>
        <a href="/signup" class="price-btn">Start Pro trial</a>
      </div>
      <div class="price-card">
        <div class="price-name">Business</div>
        <div class="price-desc">For agencies & teams</div>
        <div><span class="price-amount">$99</span><span class="price-amount-sub">/month</span></div>
        <div class="price-features">
          <div class="price-feature"><i class="ti ti-check"></i>Unlimited reports</div>
          <div class="price-feature"><i class="ti ti-check"></i>Everything in Pro</div>
          <div class="price-feature"><i class="ti ti-check"></i>Team collaboration</div>
          <div class="price-feature"><i class="ti ti-check"></i>Own API key</div>
          <div class="price-feature"><i class="ti ti-check"></i>White-label reports</div>
          <div class="price-feature"><i class="ti ti-check"></i>150K tokens per report</div>
        </div>
        <a href="/signup" class="price-btn">Get Business</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="faq-list">
      <div class="faq-item" onclick="this.classList.toggle('open')">
        <div class="faq-q">What file formats does SurveyQC accept?<i class="ti ti-plus"></i></div>
        <div class="faq-a">SurveyQC accepts .docx (Microsoft Word) files for spec documents. We support all major survey platforms: Confirmit, Decipher, Forsta, and Qualtrics. PDF support is coming soon.</div>
      </div>
      <div class="faq-item" onclick="this.classList.toggle('open')">
        <div class="faq-q">Does it work for non-English surveys?<i class="ti ti-plus"></i></div>
        <div class="faq-a">Yes — 80+ languages are fully supported including French, Italian, Arabic, Urdu, Japanese, Chinese, and more. We handle accent characters, encoding, and language-specific termination phrases correctly.</div>
      </div>
      <div class="faq-item" onclick="this.classList.toggle('open')">
        <div class="faq-q">How long does a QC report take?<i class="ti ti-plus"></i></div>
        <div class="faq-a">Most reports complete in 5–15 minutes depending on survey size. Compare this to 6–8 hours of manual QC work — a 30x time saving on average.</div>
      </div>
      <div class="faq-item" onclick="this.classList.toggle('open')">
        <div class="faq-q">Is my data safe and private?<i class="ti ti-plus"></i></div>
        <div class="faq-a">Yes. All data auto-deletes after 30 days. We are GDPR, CCPA, and India DPDP compliant. Your surveys and reports are never shared or used for AI training. You can export or delete your data anytime.</div>
      </div>
      <div class="faq-item" onclick="this.classList.toggle('open')">
        <div class="faq-q">Can I retest after fixing bugs?<i class="ti ti-plus"></i></div>
        <div class="faq-a">Yes. After fixing issues, click Retest on any report. SurveyQC will rerun QC on the same URL and only re-test the failed paths — fast and efficient.</div>
      </div>
      <div class="faq-item" onclick="this.classList.toggle('open')">
        <div class="faq-q">Can I cancel anytime?<i class="ti ti-plus"></i></div>
        <div class="faq-a">Yes — no contracts, no cancellation fees. Cancel anytime from your Billing settings. Pro and Business plans come with a 14-day free trial.</div>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="footer-grid">
      <div class="footer-brand">
        <div class="footer-brand-logo">
          ...
          <div class="footer-brand-text">SurveyQC</div>
        </div>
        <p>The world\'s first AI-powered survey QC tool. Built for QC professionals at leading market research agencies.</p>
      ...
      <div>
        ...
        <a href="mailto:support@surveyqc.online" class="footer-link">Contact</a>
      </div>
      <div>
        <div class="footer-title">Compare</div>
        <a href="/compare/chatgpt" class="footer-link">vs ChatGPT</a>
        <a href="/compare/excel" class="footer-link">vs Excel QC</a>
      ...
      <div>
        ...
        <a href="/privacy-data" class="footer-link">GDPR</a>
      </div>
    </div>
    <div class="footer-bottom">
      <p>© 2026 SurveyQC · Built for QC professionals worldwide</p>
      <div class="footer-bottom-links">
        <a href="/privacy-policy">Privacy</a>
        <a href="/terms">Terms</a>
        <a href="mailto:support@surveyqc.online">Contact</a>
      </div>
    </div>
  </div>
</footer>
