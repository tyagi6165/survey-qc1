...
/* LIGHT THEME FIX — card text must be dark (not white) */
.card p,.card span,.card h1,.card h2,.card h3,.card h4,.card label{color:var(--text)}
.card-purple p,.card-purple span,.card-purple h3,.card-purple label{color:var(--text)}
.card-hero p,.card-hero span,.card-hero h3{color:white}
/* worker-card inside admin uses dark sidebar so keep white */
.worker-card p{color:white !important}
...
<div class="app-layout">
  ...
  <div class="main-content">
    ...
    <div style="display:grid;grid-template-columns:1fr 280px;gap:16px">
      ...
      <div style="display:flex;flex-direction:column;gap:12px">
        <div class="card">
          <p style="font-size:13px;font-weight:600;color:var(--navy);margin-bottom:12px">Quick actions</p>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
            <a href="/new-qc" style="text-decoration:none;padding:12px;background:var(--bg3);border:0.5px solid var(--border);border-radius:8px;text-align:center;display:block">
              <i class="ti ti-plus" style="font-size:20px;color:var(--navy)"></i>
              <p style="font-size:11px;color:var(--text);margin-top:5px;font-weight:500">New QC</p>
            </a>
            <a href="/ai-tester" style="text-decoration:none;padding:12px;background:var(--bg3);border:0.5px solid var(--border);border-radius:8px;text-align:center;display:block">
            ...
            <a href="/reports" style="text-decoration:none;padding:12px;background:var(--bg3);border:0.5px solid var(--border);border-radius:8px;text-align:center;display:block">
            ...
            <a href="/settings" style="text-decoration:none;padding:12px;background:var(--bg3);border:0.5px solid var(--border);border-radius:8px;text-align:center;display:block">
    ...
    <div style="display:grid;grid-template-columns:1fr 220px;gap:16px">
      ...
      <div style="display:flex;flex-direction:column;gap:12px">
        <div class="card-purple">
          <p style="font-size:12px;font-weight:600;color:var(--navy);margin-bottom:12px">AI Insights</p>
          <div style="display:flex;flex-direction:column;gap:8px">
            <div style="background:rgba(4,44,83,.06);border-radius:8px;padding:10px">
              <p style="font-size:10px;color:var(--text3);margin-bottom:3px">Estimated time</p>
              <p style="font-size:14px;font-weight:600;color:var(--navy)">9 - 12 mins</p>
            </div>
            <div style="background:rgba(4,44,83,.06);border-radius:8px;padding:10px">
              <p style="font-size:10px;color:var(--text3);margin-bottom:3px">Supported languages</p>
              <p style="font-size:13px;font-weight:600;color:var(--navy)">80+ languages</p>
            </div>
            <div style="background:rgba(4,44,83,.06);border-radius:8px;padding:10px">
              <p style="font-size:10px;color:var(--text3);margin-bottom:3px">Accuracy target</p>
              <p style="font-size:13px;font-weight:600;color:#1D9E75">99%</p>
            </div>
          </div>
        </div>
        <div class="card-purple">
          <p style="font-size:12px;font-weight:600;color:var(--navy);margin-bottom:10px">Supported platforms</p>
          <div style="display:flex;flex-direction:column;gap:6px">
            <div style="display:flex;align-items:center;gap:8px;padding:7px 10px;background:rgba(4,44,83,.06);border-radius:7px"><span class="dot dot-purple"></span><span style="font-size:12px;color:var(--text)">Confirmit</span></div>
            <div style="display:flex;align-items:center;gap:8px;padding:7px 10px;background:rgba(4,44,83,.06);border-radius:7px"><span class="dot dot-amber"></span><span style="font-size:12px;color:var(--text)">Decipher</span></div>
            <div style="display:flex;align-items:center;gap:8px;padding:7px 10px;background:rgba(4,44,83,.06);border-radius:7px"><span class="dot dot-green"></span><span style="font-size:12px;color:var(--text)">Forsta</span></div>
            <div style="display:flex;align-items:center;gap:8px;padding:7px 10px;background:rgba(4,44,83,.06);border-radius:7px"><span class="dot dot-red"></span><span style="font-size:12px;color:var(--text)">Qualtrics</span></div>
          </div>
        </div>
      </div>
    </div>
...
<div class="app-layout">
  ...
  <div class="main-content">
    ...
    <div style="display:grid;grid-template-columns:1fr 300px;gap:16px">
      ...
      <div style="display:flex;flex-direction:column;gap:12px">
        <div class="card">
          <p style="font-size:13px;font-weight:600;color:var(--navy);margin-bottom:12px">Notifications</p>
          <div style="display:flex;flex-direction:column;gap:10px">
            <div style="display:flex;justify-content:space-between;align-items:center">
              <div><p style="font-size:12px;color:var(--text)">Report done</p><p style="font-size:11px;color:var(--text3)">Email on finish</p></div>
              <input type="checkbox" checked style="accent-color:var(--purple);width:16px;height:16px">
            </div>
            <div style="display:flex;justify-content:space-between;align-items:center">
              <div><p style="font-size:12px;color:var(--text)">Weekly summary</p><p style="font-size:11px;color:var(--text3)">Every Monday</p></div>
              <input type="checkbox" checked style="accent-color:var(--purple);width:16px;height:16px">
            </div>
            <div style="display:flex;justify-content:space-between;align-items:center">
              <div><p style="font-size:12px;color:var(--text)">Plan limit alert</p><p style="font-size:11px;color:var(--text3)">At 80% usage</p></div>
              <input type="checkbox" checked style="accent-color:var(--purple);width:16px;height:16px">
            </div>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div style="background:rgba(255,255,255,.06);border-radius:8px;padding:12px;display:flex;align-items:center;justify-content:space-between;margin-bottom:12px">
          <div style="display:flex;align-items:center;gap:10px">
            ...
            <div><p style="font-size:12px;color:var(--text)">No card added</p><p style="font-size:11px;color:var(--text3)">Free plan — no card needed</p></div>
          </div>
        </div>
