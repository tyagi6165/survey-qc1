...
:root {
  ...
  --blue: #378ADD;
  --purple: #042C53;
  --purple-dim: rgba(4,44,83,0.08);
  --purple-border: rgba(4,44,83,0.2);
  --text: #1A1A2E;
  --text2: #374151;
  --text3: #6B7280;
  --border: #DDE1E7;
...
.sidebar{width:200px;min-width:200px;background:#042C53;border-right:none;padding:16px 10px;display:flex;flex-direction:column;gap:2px;position:fixed;height:100vh;overflow-y:auto}
.main-content{margin-left:200px;flex:1;padding:20px;min-height:100vh;background:#F0F2F5}
.sidebar-logo{display:flex;align-items:center;gap:9px;padding:0 8px;margin-bottom:22px}
.sidebar-logo-icon{width:28px;height:28px;background:#378ADD;border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:14px;color:white;flex-shrink:0}
.sidebar-logo-text{color:white;font-size:14px;font-weight:600}
.nav-item{display:flex;align-items:center;gap:9px;padding:8px 10px;border-radius:8px;cursor:pointer;text-decoration:none;color:#85B7EB;font-size:12px;transition:all .15s}
.nav-item:hover{background:rgba(255,255,255,.08);color:white}
.nav-item.active{background:rgba(255,255,255,.15);color:white;border-left:2px solid #378ADD;padding-left:8px}
.nav-item i{font-size:13px;width:16px;text-align:center}
.nav-divider{border-top:0.5px solid rgba(255,255,255,.1);margin:6px 0}
.nav-section{font-size:9px;color:rgba(255,255,255,.3);letter-spacing:.08em;text-transform:uppercase;padding:3px 10px;margin-top:4px}

/* TOPBAR */
.topbar{display:flex;align-items:center;justify-content:space-between;margin-bottom:20px}
.page-title{font-size:18px;font-weight:600;color:#1A1A2E}
.page-sub{font-size:11px;color:#6B7280;margin-top:2px}

/* CARDS */
.card{background:white;border:0.5px solid #DDE1E7;border-radius:10px;padding:16px}
.card-sm{background:white;border:0.5px solid #DDE1E7;border-radius:10px;padding:12px}
.card-purple{background:#E6F1FB;border:0.5px solid #B5D4F4;border-radius:10px;padding:14px}
.card-hero{background:#042C53;border-radius:10px;padding:18px}

/* STATS GRID */
.stats-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:10px;margin-bottom:14px}
.stat-card{background:white;border:0.5px solid #DDE1E7;border-radius:10px;padding:14px;text-align:center}
.stat-num{font-size:20px;font-weight:600;color:#1A1A2E}
...
/* BUTTONS */
.btn{padding:8px 16px;border-radius:8px;font-size:12px;font-weight:500;cursor:pointer;border:none;display:inline-flex;align-items:center;gap:6px;text-decoration:none}
.btn-primary{background:#042C53;color:white}
.btn-primary:hover{background:#031e3b}
.btn-ghost{background:white;color:#374151;border:0.5px solid #DDE1E7}
...
.form-label{font-size:11px;color:#6B7280;margin-bottom:5px;display:block;font-weight:500}
.form-input{width:100%;background:white;border:0.5px solid #DDE1E7;border-radius:8px;padding:9px 12px;font-size:12px;color:#374151;outline:none;transition:border .2s}
.form-input:focus{border-color:#378ADD}
.form-input::placeholder{color:#9CA3AF}
.form-select{width:100%;background:white;border:0.5px solid #DDE1E7;border-radius:8px;padding:9px 12px;font-size:12px;color:#374151;outline:none;cursor:pointer}
.form-select option{background:white}
.form-check{display:flex;align-items:center;gap:8px;font-size:12px;color:#374151;cursor:pointer;margin-bottom:8px}
.form-check input{accent-color:#042C53;width:15px;height:15px;cursor:pointer}

/* UPLOAD ZONE */
.upload-zone{border:1.5px dashed #B5D4F4;border-radius:8px;padding:20px;text-align:center;cursor:pointer;transition:all .2s;background:#F8FBFF}
.upload-zone:hover{border-color:#378ADD;background:#EBF5FF}
.upload-zone.active{border-color:#1D9E75;background:#F0FDF4}
.upload-zone i{font-size:24px;color:#9CA3AF;margin-bottom:8px}
.upload-zone p{font-size:12px;color:#6B7280}
.upload-zone span{font-size:11px;color:#9CA3AF}

/* TABLE */
.data-table{width:100%;border-collapse:collapse}
.data-table th{font-size:10px;font-weight:500;color:#6B7280;text-transform:uppercase;letter-spacing:.05em;padding:9px 12px;text-align:left;border-bottom:0.5px solid #DDE1E7;background:#F8F9FA}
.data-table td{font-size:12px;color:#6B7280;padding:10px 12px;border-bottom:0.5px solid #F5F5F5}
.data-table tr:hover td{background:#FAFAFA}
.data-table td.primary{color:#1A1A2E;font-weight:500}

/* PROGRESS */
.progress-bar{height:5px;background:#F0F2F5;border-radius:3px;overflow:hidden}
.progress-fill{height:100%;border-radius:3px;transition:width .5s ease}
.progress-purple{background:#042C53}
.progress-green{background:#1D9E75}
.progress-amber{background:#EF9F27}

/* LOG BOX */
.log-box{background:#1a1a2e;border-radius:8px;padding:12px;height:180px;overflow-y:auto;font-family:'SF Mono',Monaco,monospace;font-size:10px;line-height:1.8}
...
/* SCORE CIRCLE */
.score-circle{width:70px;height:70px;border-radius:50%;border:5px solid #E8F5E9;display:flex;align-items:center;justify-content:center;flex-direction:column}
.score-num{font-size:18px;font-weight:600;color:#185FA5}
...
.dot-navy{background:#042C53}

/* ALERTS */
.alert{padding:11px 14px;border-radius:8px;font-size:12px;margin-bottom:14px}
...
.tab:hover{color:#042C53}
.tab.active{color:#042C53;border-bottom-color:#042C53}
...
.feature-card h3{font-size:14px;font-weight:500;color:#1A1A2E;margin-bottom:6px}
...
.pricing-card h3{font-size:14px;font-weight:500;color:#1A1A2E;margin-bottom:4px}
.pricing-price{font-size:28px;font-weight:500;color:#1A1A2E;margin:10px 0 4px}
...
def sidebar_html(active='dashboard'):
    ...
    for key, icon, label, href in mob_items:
        cls = 'color:white' if active == key else 'color:#85B7EB'
...
<div class="sidebar">
  ...
  <div style="margin-top:auto;padding-top:12px;border-top:0.5px solid rgba(255,255,255,.1)">
    <div style="display:flex;align-items:center;gap:8px;padding:8px 10px;border-radius:8px">
      <div class="avatar" style="background:rgba(55,138,221,.4);color:white;font-size:11px;font-weight:600">{initials}</div>
...
<!-- MOBILE BOTTOM NAV -->
<div style="display:none;position:fixed;bottom:0;left:0;right:0;background:#042C53;padding:10px 20px;justify-content:space-around;align-items:center;z-index:1000;border-top:0.5px solid rgba(255,255,255,.1)" class="mobile-bottom-nav">
  {mob_nav}
</div>
<style>
@media(max-width:768px){{
...
<div class="auth-page">
  ...
  <div class="auth-right">
    <h2 style="font-size:22px;font-weight:600;color:#1A1A2E;margin-bottom:6px">Welcome back</h2>
...
<div class="auth-page">
  ...
  <div class="auth-right">
    <h2 style="font-size:22px;font-weight:600;color:#1A1A2E;margin-bottom:6px">Create your account</h2>
    ...
    <div class="time-saved-banner">
      ...
      <div style="text-align:center">
        <div style="background:rgba(255,255,255,.1);border-radius:10px;padding:10px 18px">
          <p style="font-size:20px;font-weight:600;color:#1A1A2E">{max(1,reports_used*8)}x</p>
    ...
    <div style="display:grid;grid-template-columns:1fr 280px;gap:16px">
      <div class="card">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px">
          <p style="font-size:14px;font-weight:600;color:#1A1A2E">Recent reports</p>
    ...
    <div style="display:grid;grid-template-columns:1fr 220px;gap:16px">
      <form action="/run-qc" method="POST" enctype="multipart/form-data">
        <div class="card" style="margin-bottom:16px">
          <p style="font-size:14px;font-weight:600;color:#1A1A2E;margin-bottom:16px">Upload files</p>
        ...
        <div class="card" style="margin-bottom:16px">
          <p style="font-size:13px;font-weight:600;color:#1A1A2E;margin-bottom:14px">Checks to run</p>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
...
<div class="app-layout">
  ...
  <div class="main-content">
    ...
    <div style="display:grid;grid-template-columns:1fr 260px;gap:16px">
      <div class="card">
        <p style="font-size:14px;font-weight:600;color:#1A1A2E;margin-bottom:14px">How AI Tester works</p>
...
<div class="app-layout">
  ...
  <div class="main-content">
    ...
    <div style="display:grid;grid-template-columns:1fr 300px;gap:16px">
      <div>
        <div class="card" style="margin-bottom:16px">
          <p style="font-size:14px;font-weight:600;color:#1A1A2E;margin-bottom:16px">Profile information</p>
        ...
        <div class="card">
          <p style="font-size:14px;font-weight:600;color:#1A1A2E;margin-bottom:16px">Change password</p>
          <form method="POST">
      ...
      <div style="display:flex;flex-direction:column;gap:12px">
        <div class="card">
          <p style="font-size:13px;font-weight:600;color:#1A1A2E;margin-bottom:12px">Notifications</p>
          <div style="display:flex;flex-direction:column;gap:10px">
  ...
  <div class="main-content">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:20px">
      <div class="card {'featured' if plan=='Free' else ''}">
        <p style="font-size:13px;font-weight:600;color:#1A1A2E">Free</p>
        <p style="font-size:24px;font-weight:700;color:#1A1A2E;margin:8px 0 4px">$0<span style="font-size:13px;color:var(--text3)">/mo</span></p>
      ...
      <div class="card" style="{'border:2px solid var(--purple)' if plan=='Pro' else ''}">
        ...
        <p style="font-size:13px;font-weight:600;color:#1A1A2E">Pro</p>
        <p style="font-size:24px;font-weight:700;color:#1A1A2E;margin:8px 0 4px">$29<span style="font-size:13px;color:var(--text3)">/mo</span></p>
      ...
      <div class="card">
        <p style="font-size:13px;font-weight:600;color:#1A1A2E">Business</p>
        <p style="font-size:24px;font-weight:700;color:#1A1A2E;margin:8px 0 4px">$99<span style="font-size:13px;color:var(--text3)">/mo</span></p>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
      <div class="card">
        <p style="font-size:13px;font-weight:600;color:#1A1A2E;margin-bottom:12px">Usage this month</p>
        <div style="display:flex;justify-content:space-between;margin-bottom:6px">
      ...
      <div class="card">
        <p style="font-size:13px;font-weight:600;color:#1A1A2E;margin-bottom:12px">Payment method</p>
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center">
  <div style="width:380px">
    <div style="text-align:center;margin-bottom:28px">
      ...
      <p style="font-size:18px;font-weight:600;color:#1A1A2E">Admin access</p>
...
<div style="display:flex;min-height:100vh">
  <div style="width:200px;min-width:200px;background:#042C53;border-right:none;padding:16px 10px;position:fixed;height:100vh;overflow-y:auto">
    ...
    <a href="/admin/pages" style="display:flex;align-items:center;gap:8px;padding:8px 10px;border-radius:7px;text-decoration:none;color:#85B7EB;font-size:12px;margin-bottom:2px"><i class="ti ti-files" style="font-size:13px"></i>Pages</a>
  ...
  <div style="margin-left:200px;flex:1;padding:24px">
    ...
    <div class="card" style="margin-bottom:16px">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px">
        <p style="font-size:14px;font-weight:600;color:#1A1A2E">Users</p>
    ...
    <div class="card">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px">
        <p style="font-size:14px;font-weight:600;color:#1A1A2E">Recent QC jobs</p>
...
<div style="padding:24px;margin-left:0">
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
    ...
    <p style="font-size:20px;font-weight:600;color:#1A1A2E">All Users ({len(users_db)})</p>
  </div>
  <div class="card">
    <table class="data-table" style="width:100%">
      <thead><tr><th>Name</th><th>Email</th><th>Plan</th><th>Reports</th><th>Joined</th><th>Actions</th></tr></thead>
...
<div style="padding:24px;max-width:600px">
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
    <a href="/admin" style="color:var(--text3);text-decoration:none"><i class="ti ti-arrow-left"></i></a>
    <p style="font-size:20px;font-weight:600;color:#1A1A2E">Email Users</p>
  </div>
...
<div style="padding:24px">
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
    <a href="/admin" style="color:var(--text3);text-decoration:none"><i class="ti ti-arrow-left"></i></a>
    <p style="font-size:20px;font-weight:600;color:#1A1A2E">All QC Jobs ({len(jobs)})</p>
  </div>
  <div class="card">
    <table class="data-table" style="width:100%">
...
def admin_pages():
    ...
    if request.method == 'POST':
        ...
        if action == 'add' and slug and title:
            pages_db[slug] = {'title': title, 'content': content}
            saved = 'Page added!'
        elif action == 'edit' and slug in pages_db:
            pages_db[slug]['title'] = title
            pages_db[slug]['content'] = content
            saved = 'Page updated!'
        elif action == 'delete' and slug in pages_db:
            del pages_db[slug]
            saved = 'Page deleted!'

    pages_html = ''
    for slug, page in pages_db.items():
        pages_html += f"""
        <div class="card" style="margin-bottom:10px">
          <div style="display:flex;align-items:center;justify-content:space-between">
            <div>
              <p style="font-size:13px;font-weight:600;color:#1A1A2E">{page['title']}</p>
              <a href="/page/{slug}" style="font-size:11px;color:var(--purple);text-decoration:none">/{slug}</a>
            </div>
            <div style="display:flex;gap:8px">
              <a href="/admin/pages/edit/{slug}" class="btn btn-ghost btn-sm"><i class="ti ti-pencil"></i>Edit</a>
              <form method="POST" style="display:inline">
                <input type="hidden" name="action" value="delete">
                <input type="hidden" name="slug" value="{slug}">
                <button type="submit" class="btn btn-sm" style="background:#FCEBEB;color:#791F1F;border:0.5px solid #F7C1C1"><i class="ti ti-trash"></i></button>
              </form>
            </div>
          </div>
        </div>"""
    ...
    return render_template_string(SHARED_CSS + f"""
<!DOCTYPE html><html><head><title>Pages — Admin</title></head><body>
<div style="padding:24px;max-width:800px">
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
    <a href="/admin" style="color:var(--text3);text-decoration:none"><i class="ti ti-arrow-left"></i></a>
    <p style="font-size:20px;font-weight:600;color:#1A1A2E">Page Manager</p>
    <a href="/admin/pages/new" class="btn btn-primary btn-sm"><i class="ti ti-plus"></i>Add page</a>
  </div>
  {"<div class='alert alert-success'>" + saved + "</div>" if saved else ""}
  {pages_html if pages_html else "<div class='card' style='text-align:center;padding:30px'><i class='ti ti-file' style='font-size:32px;color:var(--text3)'></i><p style='margin-top:10px;color:var(--text3)'>No pages yet. Click Add page to create one.</p></div>"}
</div>
</body></html>""")
...
def admin_pages_new():
    ...
    return render_template_string(SHARED_CSS + """
<!DOCTYPE html><html><head><title>New Page — Admin</title></head><body>
<div style="padding:24px;max-width:700px">
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
    <a href="/admin/pages" style="color:var(--text3);text-decoration:none"><i class="ti ti-arrow-left"></i></a>
    <p style="font-size:20px;font-weight:600;color:#1A1A2E">New Page</p>
  </div>
  <div class="card">
    <form method="POST">
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px">
        <div><label class="form-label">Page title *</label><input class="form-input" name="title" placeholder="e.g. About Us" required></div>
        <div><label class="form-label">URL slug *</label><input class="form-input" name="slug" placeholder="e.g. about-us" required></div>
      </div>
      <div class="form-group">
        <label class="form-label">Content (HTML supported)</label>
        <textarea class="form-input" name="content" rows="10" placeholder="<h2>About us</h2><p>Your content here...</p>"></textarea>
      </div>
      <div style="display:flex;gap:8px">
        <button type="submit" class="btn btn-primary"><i class="ti ti-device-floppy"></i>Save & publish</button>
...
def admin_pages_edit(slug):
    if slug not in pages_db:
        return redirect('/admin/pages')
    if request.method == 'POST':
        pages_db[slug]['title'] = request.form.get('title', pages_db[slug]['title'])
        pages_db[slug]['content'] = request.form.get('content', pages_db[slug].get('content', ''))
        return redirect('/admin/pages')
    page = pages_db[slug]
    return render_template_string(SHARED_CSS + f"""
<!DOCTYPE html><html><head><title>Edit Page — Admin</title></head><body>
<div style="padding:24px;max-width:700px">
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:20px">
    <a href="/admin/pages" style="color:var(--text3);text-decoration:none"><i class="ti ti-arrow-left"></i></a>
    <p style="font-size:20px;font-weight:600;color:#1A1A2E">Edit: {page['title']}</p>
  </div>
  <div class="card">
    <form method="POST">
      <div class="form-group"><label class="form-label">Title</label><input class="form-input" name="title" value="{page['title']}"></div>
      <div class="form-group"><label class="form-label">Content</label><textarea class="form-input" name="content" rows="12">{page.get('content','')}</textarea></div>
      <div style="display:flex;gap:8px">
        <button type="submit" class="btn btn-primary"><i class="ti ti-device-floppy"></i>Save</button>
        <a href="/admin/pages" class="btn btn-ghost">Cancel</a>
        <a href="/page/{slug}" target="_blank" class="btn btn-ghost"><i class="ti ti-eye"></i>Preview</a>
      </div>
    </form>
  </div>
</div>
...
def view_page(slug):
    ...
    page = pages_db[slug]
    return render_template_string(SHARED_CSS + f"""
<!DOCTYPE html><html><head><title>{page['title']} — SurveyQC</title></head><body>
<div style="max-width:800px;margin:0 auto;padding:40px 20px">
  <a href="/" style="color:var(--text3);text-decoration:none;font-size:13px"><i class="ti ti-arrow-left"></i> Back</a>
  <h1 style="font-size:28px;font-weight:600;color:#1A1A2E;margin:20px 0 16px">{page['title']}</h1>
  <div class="card">{page.get('content','')}</div>
</div>
</body></html>""")
